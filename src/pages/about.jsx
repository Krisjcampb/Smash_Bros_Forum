            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{
                        ...
                        A hub for the Pacific Northwest Smash community
                    </p>
                </div>
                ...
                <div style={{
                    ...
                    <p style={{ color: '#444', lineHeight: '1.8', marginBottom: '2rem' }}>
                        ...
                        our favorite games in one of our favorite regions.
                    </p>
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <div style={{ color: '#888', fontSize: '0.82rem', marginTop: '0.2rem' }}>
                                Follow @PNWSmashHub on Twitter and share the site with your crew
                            </div>
                        </div>
                        <a
                            href="/feedback"
